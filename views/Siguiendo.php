        ...
        <div class="p-6">
            ...
            <div class="border-b border-gray-800 mb-6">
                <nav class="flex gap-6">
                    <a href="../views/Siguiendo.php" class="text-white pb-4 border-b-2 border-[#7C3AED]">Siguiendo</a>
            ...
            <!-- Ranking List -->
            <div class="space-y-4">
                <h2 class="text-xl font-bold mb-4">Este Tornneo no tiene Seguidores</h2>
