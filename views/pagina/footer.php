<footer class="bg-transparent text-white py-16">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li class="flex items-center gap-3">
                        ...
                        <a href="#" class="text-gray-300 hover:text-[#4d47f5] transition-colors">Fútbol</a>
                    </li>
                    <li class="flex items-center gap-3">
                        <i class="fas fa-list-alt text-lg text-gray-400"></i>
                        <a href="#" class="text-gray-300 hover:text-[#4d47f5] transition-colors">Ligas</a>
                    </li>
                    <li class="flex items-center gap-3">
                        <i class="fas fa-users text-lg text-gray-400"></i>
                        <a href="#" class="text-gray-300 hover:text-[#4d47f5] transition-colors">Equipos</a>
                    </li>
                    <li class="flex items-center gap-3">
                        <i class="fas fa-user text-lg text-gray-400"></i>
                        <a href="#" class="text-gray-300 hover:text-[#4d47f5] transition-colors">Jugadores</a>
                    </li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li class="flex items-center gap-3">
                        ...
                        <a href="#" class="text-gray-300 hover:text-[#4d47f5] transition-colors">Centro de ayuda</a>
                    </li>
                    <li class="flex items-center gap-3">
                        <i class="fas fa-phone text-lg text-gray-400"></i>
                        <a href="#" class="text-gray-300 hover:text-[#4d47f5] transition-colors">Contacto</a>
                    </li>
                    <li class="flex items-center gap-3">
                        <i class="fas fa-user-secret text-lg text-gray-400"></i>
                        <a href="#" class="text-gray-300 hover:text-[#4d47f5] transition-colors">Política de privacidad</a>
                    </li>
                    <li class="flex items-center gap-3">
                        <i class="fas fa-file-contract text-lg text-gray-400"></i>
                        <a href="#" class="text-gray-300 hover:text-[#4d47f5] transition-colors">Términos de uso</a>
                    </li>
                </ul>
            </div>
